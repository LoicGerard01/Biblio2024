...
public class Gestion {
    ...
    private void gestRayons() {
        ...
        lrayon.add(new Rayon(codeRayon,genre));
    ...
    private void gestOuvrages() {
        ...
        int m = Integer.parseInt(jma[1]);
        int a = Integer.parseInt(jma[2]);
        dateParution= LocalDate.of(a,m,j);

        System.out.println("type de l'ouvrage");
        ...
        choix = sc.nextInt();
        switch (choix){
            case 1 : typeOuvrage = LIVRE; break;
            case 2 : typeOuvrage = CD; break;
            case 3 : typeOuvrage = DVD; break;
            default:
