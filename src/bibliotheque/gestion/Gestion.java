        ...
        switch (choix) {
            ...
            case 3:
                ...
                do {
                    choix = Utilitaire.choixListe(langues);
                    if (choix == langues.size()) break;
                    String nouveau = langues.get(choix - 1);
                    boolean existe = false;

                    for (String sousTitre : ((DVD) o).getSousTitres()) {
                        if (sousTitre.equals(nouveau)) {
                            System.out.println("langue déja présente");
                            existe = true;
                            break;
                        }
                    }
                    if (!existe) ((DVD) o).getSousTitres().add(langues.get(choix - 1));//TODO vérifier unicité ou utiliser set
                } while (true);
                ;
                break;
        }
